...
class SportsAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        val root = LinearLayout(c).apply {
            ...
            background =
                ContextCompat.getDrawable(c, R.drawable.bg_focus)
        ...
        val state =
            tv(7.5f, R.color.adwio_muted).apply {
                gravity = Gravity.CENTER
            }
    ...
    override fun onBindViewHolder(
        ...
        h.homeLogo.setImageResource(
            R.drawable.ic_adwio
        )

        h.awayLogo.setImageResource(
            R.drawable.ic_adwio
        )
